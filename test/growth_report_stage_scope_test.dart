...
void main() {
  testWidgets('growth report shows stage scope from constructor', (
    ...
    expect(find.text('静夜思 · 91 分'), findsOneWidget);
    expect(find.text('春晓 · 94 分'), findsOneWidget);
    expect(find.text('静夜思 · 缺字漏字'), findsOneWidget);
    expect(find.text('春晓 · 缺字漏字'), findsOneWidget);
    expect(find.text('静夜思 · 88 分'), findsOneWidget);
    expect(find.text('春晓 · 92 分'), findsOneWidget);
    ...
    expect(find.text('江雪 · 95 分'), findsNothing);
    expect(find.text('江雪 · 缺字漏字'), findsNothing);
    ...
    await tester.pumpAndSettle();
    expect(find.text('江雪 · 95 分'), findsOneWidget);
    expect(find.text('查看当天学习记录'), findsOneWidget);
    expect(find.text('查看练习结果'), findsOneWidget);
    expect(find.text('查看本关错题'), findsOneWidget);
    await tester.ensureVisible(find.bySemanticsLabel(RegExp('春晓 · 94 分')));
    await tester.pumpAndSettle();
    await tester.tap(find.bySemanticsLabel(RegExp('春晓 · 94 分')));
    ...
    await tester.ensureVisible(find.bySemanticsLabel(RegExp('春晓 · 92 分')));
    await tester.pumpAndSettle();
    await tester.tap(find.bySemanticsLabel(RegExp('春晓 · 92 分')));
    await tester.pumpAndSettle(const Duration(milliseconds: 100));
    ...
    expect(find.text('春晓 · 92 分'), findsOneWidget);
    expect(find.textContaining('已回到这条记录'), findsWidgets);
    await tester.ensureVisible(find.bySemanticsLabel(RegExp('春晓 · 缺字漏字')));
    await tester.pumpAndSettle();
    await tester.tap(find.bySemanticsLabel(RegExp('春晓 · 缺字漏字')));
    await tester.pumpAndSettle(const Duration(milliseconds: 100));
